...
function criarTabelas() {
    ...
    const tabelaAWS = `
    CREATE TABLE IF NOT EXISTS tabela_aws (
      id INT AUTO_INCREMENT PRIMARY KEY,
      id_usuario INT,
      FOREIGN KEY (id_usuario) REFERENCES usuario (id),
      referencia VARCHAR(255)
  ...
  `;
    ...
    conexao.query(tabelaAWS, (err) => {
      if (err) {
        console.error('Erro ao criar a tabela aws:' , err);
        return;
      }
      console.log('Tabela "aws" craida ou ja existente.')
    })
  }
